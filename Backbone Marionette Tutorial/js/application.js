...
$(document).ready(function(){
  var cats = new AngryCats([
      new AngryCat({ name: 'Alfred', image_path: 'images/cat2.jpg' }),
      new AngryCat({ name: 'Barbara', image_path: 'images/cat1.jpg' }),
      new AngryCat({ name: 'Charlie', image_path: 'images/cat3.jpg' })
  ]);
